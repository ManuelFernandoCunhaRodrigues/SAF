...
const buttonVariants = cva(
  'cursor-pointer group whitespace-nowrap focus-visible:outline-none inline-flex items-center justify-center text-sm font-medium ring-offset-background transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-60 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        md: 'h-9 rounded-md px-3 gap-1.5 text-[0.8125rem] [&_svg:not([class*=size-])]:size-4',
      ...
      mode: {
        ...
        input: 'justify-start font-normal hover:bg-background border border-input focus-visible:border-ring focus-visible:ring-2 focus-visible:ring-ring/30',
      },
      placeholder: {
...
function Button({
  ...
  return (
    <Comp
      data-slot="button"
      className={cn(
        buttonVariants({ variant, size, shape, appearance, mode, placeholder, className }),
